...
As suggested and demonstrated by our professor, we used a generative AI tool (specifically \texttt{v0} by Vercel) to develop the front end of our website. Due to limited experience with the libraries suggested by \texttt{v0} and with TypeScript, we also made limited use of VS Code’s IDE auto-completion features. Additionally, since the configurable-multiple-test design was secondary to the application of the LSAT sections, the specific prompt-directions for those were generated generically from the LSAT ones written by us. 
